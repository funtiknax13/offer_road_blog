...
{{< figure src="images/screenshot-1.png" caption="Хиро-блок портфолио fedorov-dev.ru: шапка сайта, стек технологий и переключатель языка" >}}
...
{{< figure src="images/screenshot-2.png" caption="Карусель проектов на fedorov-dev.ru, включая airunningcoach.pro" >}}
